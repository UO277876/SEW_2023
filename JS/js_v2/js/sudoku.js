class Sudoku {
        ...
        for (let i=0; i < this.tablero.length; i++) {
            for (let j=0; j < this.tablero[i].length; j++) {
                ...
                if(this.tablero[i][j] == 0){
                    ...
                    cells[aux].addEventListener('click', this.cellClicked.bind(cells[aux]));
    ...
    */
    introduceNumber(number) {
        ...
        cells[aux].removeEventListener('click',this.cellClicked.bind(cells[aux]));
